<!-- Banner at the top of randomClustering.php -->
<html>
<?php
...
if (isset($_SESSION['type'])) { // Create redirect links for banner.
  ...
  if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']) {
    $logout = "<a class= 'logout-button pull-right' href='logout.php' style='font-size: 25px; margin-top:20px; margin-right:20px;'>Logout</a>";
  } else {
    $logout = "";
  }

  $banner = '<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#d3d3d3;border-style: outset";>
